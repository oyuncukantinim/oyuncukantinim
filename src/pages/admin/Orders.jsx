    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg p-6 max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-2">
          ...
          {isCancelled ? (
            <div className="text-center text-sm text-gray-500 font-semibold bg-gray-50 border border-gray-200 rounded-xl py-2.5">
              Bu sipariş iptal & iade edildi. Başka işlem yapılamaz.
            </div>
          ) : (
            <>
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {loading ? (
                  ...
                  return (
                    <tr key={o.id} className={`border-t border-gray-50 hover:bg-gray-50/50 ${ds === 3 ? 'bg-red-50/30' : ds === 4 ? 'bg-gray-50/60' : ''}`}>
