                          ...
                          <div className="grid grid-cols-4 gap-1.5 sm:grid-cols-5 md:grid-cols-6 lg:grid-cols-8">
                            ...
                            >
                              <div className="text-center">
                                ...
                                <div className="mt-1 text-xs font-bold text-emerald-600">0₺</div>
                                {!selectedHours ? <span className="mt-1 inline-block rounded-full bg-slate-700 px-1.5 py-0.5 text-[10px] font-bold text-white">Seçili</span> : null}
                              </div>
                            </button>
                              ...
                              return (
                                ...
                                >
                                  <div className="text-center">
                                    ...
                                    <div className="mt-0.5 text-xs font-semibold text-slate-500">{Number(option.price).toFixed(2)}₺</div>
                                    {selected ? <span className="mt-1 inline-block rounded-full bg-violet-600 px-1.5 py-0.5 text-[10px] font-bold text-white">Seçili</span> : null}
                                    {insufficient ? (
                                      <div className="mt-1 text-[10px] font-bold text-red-500">Yetersiz</div>
                                    ) : null}
                                  </div>
                                </button>
                              );
