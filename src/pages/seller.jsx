    ...
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      {activeTab === 'achievements' && (
        <div className="space-y-5">
          <div className="seller-achievements-hero relative overflow-hidden rounded-3xl border border-violet-100 bg-gradient-to-br from-slate-950 via-violet-950 to-cyan-900 p-6 text-white shadow-xl">
              ...
              {reviews.map((review) => (
                <div key={review.id} className="card p-5 flex gap-4">
                  <div className="flex flex-col items-center gap-1 flex-shrink-0 w-16 text-center">
                    ...
                    <Link to={`/p/${review.reviewer_username}`} className="inline-flex max-w-full items-center justify-center gap-1 font-bold text-gray-700 hover:text-neon-purple text-[11px] leading-tight transition-colors">
                      <span className="line-clamp-2 min-w-0">{review.reviewer_username}</span>
                ...
                >
                  ...
                  <div className="min-w-0">
                    <div className="flex min-w-0 items-center gap-1">
                      <span className="truncate text-sm font-extrabold text-gray-800">{follower.username}</span>
                      {isIdentityVerified(follower) ? <IdentityVerifiedIcon compact /> : null}
                    </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
              {following.map((followed) => (
                ...
                >
                  ...
                  <div className="min-w-0">
                    <div className="flex min-w-0 items-center gap-1">
                      <span className="truncate text-sm font-extrabold text-gray-800">{followed.username}</span>
                      {isIdentityVerified(followed) ? <IdentityVerifiedIcon compact /> : null}
                    </div>
