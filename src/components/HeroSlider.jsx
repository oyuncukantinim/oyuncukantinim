...
export default function HeroSlider() {
  ...
  if (!loaded) {
    return (
      <section className="relative left-1/2 -mt-8 h-[560px] w-screen -translate-x-1/2 overflow-visible sm:h-[610px] lg:h-[650px]">
  ...
  return (
    <section
      className="hero-slider group/hero relative left-1/2 -mt-8 h-[560px] w-screen -translate-x-1/2 overflow-visible text-white sm:h-[610px] lg:h-[650px]"
    ...
    >
      ...
      {/* ============== CONTENT LAYOUT ============== */}
      <div
        className="absolute inset-x-0 bottom-52 mx-auto flex w-full max-w-[1480px] flex-col justify-end px-4 pb-4 sm:bottom-56 sm:px-10 sm:pb-6 lg:bottom-60 lg:px-16 lg:pb-8"
        onMouseEnter={() => setPaused(true)}
        onMouseLeave={() => setPaused(false)}
      >
        {/* ----- Card ----- */}
