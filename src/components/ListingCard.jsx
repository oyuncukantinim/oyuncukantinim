...
const DOPING_META = {
  vitrine: { label: 'Vitrin', Icon: Star, strip: 'bg-amber-700/85', ring: 'border-yellow-300/85 ring-amber-300/45 ring-offset-2 ring-offset-white shadow-[0_0_0_1px_rgba(251,191,36,0.55),0_0_12px_-5px_rgba(245,158,11,0.55),0_16px_34px_-26px_rgba(180,83,9,0.55)] dark:border-yellow-300/80 dark:ring-yellow-300/45 dark:ring-offset-slate-950 dark:shadow-[0_0_0_1px_rgba(250,204,21,0.58),0_0_14px_-5px_rgba(250,204,21,0.55),0_18px_38px_-28px_rgba(250,204,21,0.48)]' },
